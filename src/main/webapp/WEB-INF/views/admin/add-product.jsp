					...
					<div class="hover-scroll-overlay-y px-2 my-5 my-lg-5"
						...
						<div
							...
							<div class="menu-item">
								...
								</span> <span class="menu-title">Products</span>
								</a>
							</div>
							<div class="menu-item">
								...
								</span> <span class="menu-title">Orders</span>
								</a>
							</div>
							<div class="menu-item">
							...
							<div class="menu-item">
								<a class="menu-link active" href="/admin/add-product"> <span
									class="menu-icon"> <span class="svg-icon svg-icon-2">
											<svg xmlns="http://www.w3.org/2000/svg" width="24"
												height="24" viewBox="0 0 24 24" fill="none">
													<path
			...
			<div class="wrapper d-flex flex-column flex-row-fluid"
				...
				<div id="kt_header" style="" class="header align-items-stretch">
					<div class="header-brand">
						<a href="/"> <img alt="Logo" src="/assets/img/footer-logo.png"
							...
							<div class="page-title d-flex flex-column me-5">
								...
								<ul
									...
									<li class="breadcrumb-item text-muted"><a
										href="/admin/product" class="text-muted text-hover-primary">Admin</a>
									</li>
							...
							<div class="card pb-3">
								<div class="card-header border-0 pt-6">
									<div class="card-title w-100 d-block">
										...
										<form:form modelAttribute="productAdd"
											action="/admin/add-product" method="post"
											enctype="multipart/form-data">
											<div class="img_up">
												<div class="d-plex">
													<div class="img_upload_button">
														<span class="file-preview"> <span
															style="position: absolute; inset: 0px; padding-top: 30px;">
																<svg viewBox="0 0 1000 1000">
																	...
																	</svg> <span class="help-text">Choose files or drag
																	&amp; drop here</span>
														</span>
														</span>
													</div>
												</div>
												<input onchange="changeFile(this)" name="images"
													class="input_upload_file" type="file" id="file-uploader"
													accept=".jpg, .png" multiple="multiple" required="required" />
											</div>
											<div class="mb-3 mt-3">
											...
											<div class="mb-3">
												...
												<form:input id="price" path="price" type="number" min="0"
													class="form-control" required="required" />
											</div>
											<div class="mb-3">
											...
											<div class="mb-3">
												<label for="exampleInputEmail1" class="form-label">Category
													<span class="form-text text-danger">*</span>
												</label> <select id="category" name="categoryId"
													class="form-control">
					...
					<div
						...
						<div class="text-dark order-2 order-md-1">
							<span class="text-muted fw-bold me-1">2023©</span> <a
								...
								class="text-gray-800 text-hover-primary">Vuong Coder</a>
						</div>
					</div>
				</div>
			</div>
