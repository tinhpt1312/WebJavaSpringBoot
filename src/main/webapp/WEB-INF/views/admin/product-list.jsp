...
<body>
					...
					<div class="aside-menu flex-column-fluid">
						<div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="{default: '#kt_aside_toolbar, #kt_aside_footer', lg: '#kt_header, #kt_aside_toolbar, #kt_aside_footer'}" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="5px">
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active" href="/admin/product">
										...
										<div class="card-title">
											<div class="d-flex align-items-center position-relative my-1">
												...
												<form action="/admin/product" method="get">
													<input type="text" data-kt-user-table-filter="search" name="name" value="${name}" class="form-control form-control-solid w-250px ps-14" placeholder="Search product" />
												</form>
											</div>
										</div>
									</div>
													...
													<tr>
														<td class="d-flex align-items-center">
															<div class="d-flex flex-column">
																<a href="#" class="text-gray-800 text-hover-primary mb-1">${p.name}</a>
																<span>${p.price}</span>
															</div>
														</td>
														<td>${p.quantity}</td>
														...
														<td>${!p.isDelete}</td>
														<td class="text-end">
															<a href="#" data-bs-toggle="modal" data-bs-target="#productModal" onclick="editProduct('${p.id}+${p.name}+${p.price}+${p.quantity}+${p.createDate}+${!p.isDelete}+${p.category.id}')" class="btn btn-warning btn-active-light-primary btn-sm p-1">
																<i class="p-0 bi bi-pencil-square"></i>
															</a>
															<a href="/admin/product/delete/${p.id}" class="btn btn-danger btn-active-light-primary btn-sm p-1">
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form:form action="/admin/product/edit" method="post" modelAttribute="productEdit">
			  <div class="mb-3">
			    <label for="exampleInputEmail1" class="form-label">ID <span class="form-text text-danger">*</span></label>
			  ...
			  <div class="mb-3">
			    <label for="exampleInputEmail1" class="form-label">Create Date <span class="form-text text-danger">*</span></label>
			  ...
			  <div class="d-flex mb-3 mt-5">
			    <label class="form-label me-3">Activated: </label>
			  	<div class="me-3 mt-1">
			      <form:checkbox id="isDelete" value="true" path="isDelete" />
			    </div>
			  </div>
			  <div class="mb-3">
	...
	<script type="text/javascript">
		function editProduct(pro) {
			...
			document.getElementById("isDelete").checked = (account[5]=='true')?true:false;
	...
	<c:if test="${not empty error_product_delete}">
		<script type="text/javascript">
			alertUser('Error!', 'Delete fail!', 'error');
		</script>
	</c:if>
	<c:if test="${not empty success_product_delete}">
		<script type="text/javascript">
			alertUser('Success!', 'Delete success!', 'success');
		</script>
	</c:if>
	<c:if test="${not empty error_product_update}">
		<script type="text/javascript">
			alertUser('Error!', 'Update fail!', 'error');
		</script>
	</c:if>
	<c:if test="${not empty success_product_update}">
		<script type="text/javascript">
