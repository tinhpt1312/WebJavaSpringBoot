					...
					<div class="aside-menu flex-column-fluid">
						<div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="{default: '#kt_aside_toolbar, #kt_aside_footer', lg: '#kt_header, #kt_aside_toolbar, #kt_aside_footer'}" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="5px">
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link active" href="/admin/order">
										<span class="menu-icon">
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
													<path d="M21 10H13V11C13 11.6 12.6 12 12 12C11.4 12 11 11.6 11 11V10H3C2.4 10 2 10.4 2 11V13H22V11C22 10.4 21.6 10 21 10Z" fill="black" />
										...
										<div class="card-title">
											<div class="d-flex align-items-center position-relative my-1">
												...
												<form action="/admin/order" method="get">
													<input type="text" data-kt-user-table-filter="search" name="id" value="${id}" class="form-control form-control-solid w-250px ps-14" placeholder="Search order" />
												</form>
											</div>
										</div>
									</div>
											...
											<tbody class="text-gray-600 fw-bold">
												<c:forEach items="${orderList}" var="o">
													<tr>
														...
														<td>${o.createDate}</td>
														<td>${o.total}</td>
														<td class="${o.status?'text-success':'text-warning'}">${o.status?'Đã thanh toán':'Chưa thanh toán'}</td>
														<td class="text-end">
															<a href="#" onclick="detail('${o.id}')" class="btn btn-secondary btn-active-light-primary btn-sm p-1">
																<i class="p-0 bi bi-three-dots"></i>
															</a>
														</td>
													</tr>
													<tr id="${o.id}detailTitle" class="d-none">
														<td colspan="2">Product Name</td>
														<td class="text-end" colspan="2">Quantity</td>
														<td class="text-end" colspan="2">Price</td>
													</tr>
													<c:forEach items="${o.orderDetails}" var="item">
														<tr class="d-none ${o.id}detail">
															<td colspan="2">${item.product.name}</td>
															<td class="text-end" colspan="2">${item.quantity}</td>
